      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-lg transition-shadow">
            ...
            <p className="text-slate-600 leading-relaxed">
              Gestão completa de pacientes, agendamentos, prontuários
              eletrônicos, equipe médica e financeiro integrado com DRE, fluxo
              de caixa e repasses. Tudo em um painel web moderno e seguro.
            </p>
          </div>
          ...
          <div className="bg-slate-50 rounded-3xl p-8 hover:shadow-lg transition-shadow">
            ...
            <p className="text-slate-600 leading-relaxed">
              Dados protegidos com criptografia, sistema de auditoria completo e
              conformidade com a LGPD. Seu prontuário é sigiloso.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "Histórico médico completo e acessível",
              },
              {
                icon: Users,
                title: "Conexão Médico-Paciente",
                desc: "Comunicação segura e direta",
              },
              {
                icon: Lock,
              ...
              },
              {
                ...
                desc: "Rastreabilidade total de operações",
              },
            ].map((item) => (
              <div
                key={item.title}
