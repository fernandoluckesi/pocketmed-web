...
const MY_PATIENTS: MyPatient[] = [
  ...
  },
  {
    ...
    name: "Roberto Alcântara",
    patientId: "#PK-8841",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAVNPUgwiMvHkkEM59m_0fbcbfJg5AHKCJcZBeFRw8hBrWj1fCKFJO8j_LuVpNeqL7imv_eHaSYIPS0rLT1wuzQvEqSJNZLvaKvdU0beKJ7KERCTEBawSng4mmSYb1LWFNzyRaCBaS4X_wLdlFqN7FPbCldW0qvGJAEAZ7EoRQFtAULFWWKYKlstkz2vhdS78FOY1sIW0AGuWjOiwJYn_wHIc7PvbXAh0dHcw2iFdON31jEPAQPocgvi6KK6fIv__5ThaYaQeTdIViI",
    age: 52,
    bloodType: "A-",
  ...
  },
  {
    ...
    name: "Lucas Mendes",
    patientId: "#PK-7712",
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDkpVgyNgZcFpQWg4GYULvjwYRGutWwrXkiQVgm0ufCSSibckAIfYp8H7LllJBnK_GCYaRjL5Rxo19n7Vqyou_IrXDTfCZId7TS7hE9mkXe7eBr73D4W1n_f2zivmzNGK50pHXnURpD7M-bWK8_1W7ilrXwyDjjEdkT9F7c5L87Uz2WqqAmaZoTXJTZLoHlM-joUgHwJXoYIJvanD3zT4jBh9x8GMJsGYsTBC7249xcsZKwpnOfVPJEaI-wKnfnO9LQv0C1nNijVy0A",
    age: 29,
    bloodType: "B+",
    lastConsultation: "Ontem",
    conditions: ["Recuperação de Joelho"],
        ...
        {MY_PATIENTS.map((patient, idx) => (
          ...
          >
            <div className="flex items-start gap-4 mb-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-gray-500 text-sm font-medium">
                  {patient.patientId} • {patient.age} anos • {patient.bloodType}
                </p>
              </div>
            ...
            <div className="pt-4 border-t border-gray-100 flex items-center justify-between">
              <span className="text-xs font-semibold text-gray-400">Ver prontuário completo</span>
