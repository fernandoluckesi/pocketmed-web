    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-lg border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm font-bold text-slate-700 hover:text-primary transition-colors px-4 py-2.5">
              Entrar
            </Link>
            <Link to="/signup" className="bg-primary text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-blue-700 transition-colors shadow-sm">
              Criar Conta
            </Link>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-slate-600 leading-relaxed mb-10">
                O PocketMed conecta pacientes e profissionais de saúde em uma plataforma
                segura. Acesse consultas, exames e histórico médico de qualquer lugar.
              </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-br from-emerald-50 to-white rounded-3xl p-10 border border-emerald-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-extrabold text-slate-900 mb-3">Para Pacientes</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
              Acesse seu prontuário completo pelo celular. Consultas, exames, medicamentos,
              vacinas e alergias — tudo organizado e seguro.
            </p>
            <ul className="space-y-3 mb-8">
              {["Histórico de consultas", "Resultados de exames", "Controle de medicamentos", "Cartao de vacinas", "Notificações em tempo real"].map((item) => (
            ...
            <Link to="/institutional/mobile" className="text-primary font-bold text-sm flex items-center gap-2 hover:gap-3 transition-all">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-3xl p-10 border border-blue-100 hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-extrabold text-slate-900 mb-3">Para Profissionais</h3>
            <p className="text-slate-600 mb-6 leading-relaxed">
              Gerencie pacientes, prontuários, agenda e equipe médica em um painel
              web completo, moderno e seguro.
            </p>
            <ul className="space-y-3 mb-8">
              {["Prontuário eletrônico", "Gestão de agenda", "Equipe e clínica", "Financeiro integrado", "Auditoria completa"].map((item) => (
                <li key={item} className="flex items-center gap-2 text-sm text-slate-700">
            ...
            <Link to="/institutional/platform" className="text-primary font-bold text-sm flex items-center gap-2 hover:gap-3 transition-all">
      ...
      <section className="bg-slate-900 text-white py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: Shield, title: "Segurança Avançada", desc: "Criptografia, auditoria, hash de integridade e detecção de anomalias." },
              { icon: Users, title: "Controle de Acesso", desc: "Voce decide quem ve seu prontuário. Concessao e revogação instantânea." },
              { icon: Calendar, title: "Agenda Inteligente", desc: "Agendamento, lembretes e aprovações de consultas automatizadas." },
              { icon: Pill, title: "Gestão de Medicamentos", desc: "Histórico completo de prescrições com dosagens e duracao." },
              { icon: BarChart3, title: "Financeiro", desc: "Dashboard com receitas, despesas, repasses e DRE para clínicas." },
              { icon: Bell, title: "Notificações Push", desc: "Alertas em tempo real sobre consultas, exames e aprovações." },
            ].map((item) => (
              <div key={item.title} className="bg-white/5 rounded-2xl p-7 border border-white/10 hover:border-primary/30 transition-colors">
        ...
        <div className="bg-gradient-to-r from-primary to-blue-700 rounded-3xl p-12 md:p-16 text-white text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <blockquote className="text-2xl md:text-3xl font-bold leading-snug mb-8 max-w-3xl mx-auto">
              "O PocketMed transformou a forma como gerencio minha clínica.
              Tudo integrado, seguro e acessível."
            </blockquote>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 text-center">
        ...
        <p className="text-lg text-slate-600 max-w-xl mx-auto mb-10">
          Crie sua conta em menos de 2 minutos e tenha acesso a todas as funcionalidades.
        </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm text-slate-500">
              ...
              <Link to="/institutional/platform" className="hover:text-primary transition-colors">Plataforma Web</Link>
            </div>
            <p className="text-sm text-slate-400">
              &copy; {new Date().getFullYear()} PocketMed Clínical Systems. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
      ...
      {/* Legal Modals */}
      <LegalModal open={activeModal === "privacy"} onClose={() => setActiveModal(null)} title="Política de Privacidade">
        <PrivacyPolicyContent />
      </LegalModal>
      <LegalModal open={activeModal === "terms"} onClose={() => setActiveModal(null)} title="Termos de Serviço">
        <TermsOfServiceContent />
      </LegalModal>
      <LegalModal open={activeModal === "security"} onClose={() => setActiveModal(null)} title="Padrões de Segurança">
        <SecurityStandardsContent />
      </LegalModal>
    </div>
  );
